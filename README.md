...
file edited in between, and how long those runs took. That is the work a cache of results could have saved. It needs
nothing installed and writes nothing:
...
同じ場所で同じ重いコマンドをもう一度)の本数と所要も数える。結果を使い回せていれば省けた仕事の量になる。入れなくても動き、何も書かない:
